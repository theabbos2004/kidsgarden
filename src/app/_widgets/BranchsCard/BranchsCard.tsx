    ...
    <Card>
      ...
      <CardFooter className="flex gap-2">
        <Button asChild variant="green" className="rounded-3xl flex-1">
          <Link href={`dashboard/branchs/${card.id}`}>
            Filyalarni ko‘rsatish
          </Link>
        </Button>
        <Button asChild variant="outline" className="rounded-3xl flex-1">
          <Link href={`dashboard/branchs/${card.id}`}>Guruhlar</Link>
        </Button>
        <Popover>
          <PopoverTrigger>
